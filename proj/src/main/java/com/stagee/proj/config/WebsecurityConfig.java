...
public class WebsecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET,"/v1/cars").hasAnyRole("ROLE_MEDECIN","MEDECIN","INFERMIER")
			
		.antMatchers(HttpMethod.GET,"/v1/user").hasAnyRole("ADMIN","MANAGER")
		.antMatchers(HttpMethod.GET,"/v1/users/{userId}").access("@userSecurity.hasUserId(authentication,#userId)").anyRequest().authenticated()
		;
